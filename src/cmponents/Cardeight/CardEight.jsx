...
const CardEight = () => {
    ...
    useEffect(() => {
        ...
        const sequence = async () => {
            ...
            await controls.start({ rotate: 90, x:"-3vw", y:"-15vh", transition: { type: "spring", duration: 2, stiffness: 70 , delay: 0.5 } });
    ...
    return ( 
        <motion.div
        className="w-64 h-40 bg-yellow-400 rounded-xl text-slate-100 py-3 px-4 absolute"
        whileHover={{scale:1.2}}
        initial={{ x: "-100vw", y:"15vh" , rotate: 0 }}
        animate={controls}
    >
